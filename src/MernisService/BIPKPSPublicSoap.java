...
public class BIPKPSPublicSoap
{
    ...
    public BIPKPSPublicSoap(){}

    public BIPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BIPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BIPExtendedSoapSerializationEnvelope envelope= new BIPExtendedSoapSerializationEnvelope(BIPExtendedSoapSerializationEnvelope.VER11);
