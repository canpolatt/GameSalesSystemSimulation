...
public class BIPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BIPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BIPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BIPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BIPDateTimeConverter dateTimeConverter = new BIPStandardDateTimeConverter();

    public BIPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BIPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BIPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BIPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BIPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BIPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
